...
\titlespacing*{\chapter}{0pt}{-15pt}{40pt} \titlespacing*{\section}{0pt}{0pt}{20pt}
...
\begin{figure}[htp]
    \centering
    \includegraphics[scale=0.85]{subgiants_mgh.pdf}
    \includegraphics[scale=0.85]{subgiants_mgfe.pdf}
...
\begin{figure}[htp]
    \includegraphics[scale=0.8]{y_c_cc-2.pdf}
    \includegraphics[scale=0.8]{y_co_cc.pdf}
...
\begin{figure*}
\includegraphics[scale=0.9]{oob_agb.pdf}
