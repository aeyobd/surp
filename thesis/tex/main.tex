...
%%%%%%%%%%%%%%% Acronyms %%%%%%%%%%%%%%%%%%
\usepackage[automake,symbols,nogroupskip,counter=section]{glossaries-extra}
\makeglossaries
...
\glsxtrnewsymbol
[description = {The metal fraction (by weight), i.e. the fraction of material that is not hydrogen or helium}]
{Z}{\ensuremath{Z}}

\newglossaryentry{mtly}{name={metallicity},
