...
% these don't work with lualatex/phase-iii
%\usepackage{accsupp}
...
%%%%%%%%%%%%%%% Acronyms %%%%%%%%%%%%%%%%%%
\usepackage[acronym,automake,symbols,nogroupskip,counter=section]{glossaries-extra}
...
% \newabbreviation
% [description={massive star explosions}]
% {cc}{ccsne}{core collapse supernovae}

\newacronym
[ description={heelloo}, seealso={ccg} ]
{cc}{ccsne}{core collapse supernovae}
...
\glsxtrnewsymbol
[description = {The symbol for the sun}]
{sun}{\ensuremath{\odot}}
...
\renewcommand{\eta}{\gls{eta}}
\renewcommand{\zeta}{\gls{zeta}}
...
\newglossaryentry{ccg}
{
    ...
    description ={massive star explosions. core collapse supernovae (\textcs{ccsne}) produce many elements including $\alpha$-elements, Fe-peak elements, and r and s-process elements.}
}
...
\newglossaryentry{c11}
{
    name={C11},
    type={models},
    description={the yield set from \citet{cristallo+11,cristallo+15}},
}
\newglossaryentry{k10}
{
    name={K10},
    type={models},
    description={the yield set from \citet{karakas10}},
}
\newglossaryentry{v13}
{
    name={V13},
    type={models},
    description={the \agb\ yield set from \citet{ventura+13,ventura+14,ventura+18,ventura+20}},
}
\newglossaryentry{k16}
{
    name={K16},
    type={models},
    description={the yield set from \citet{KL16, karakas+18}},
}


\newcommand{\cxi}{\gls{c11}}
\newcommand{\kx}{\gls{k10}}
\newcommand{\kxvi}{\gls{k16}}
\newcommand{\vviii}{\gls{v13}}
...
\begin{figure}[htp]
    \includegraphics[width=\textwidth]{subgiants_mgh.pdf}
    \includegraphics[width=\textwidth]{subgiants_mgfe.pdf}
