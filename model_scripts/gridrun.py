...
if __name__ == "__main__":
    ...
    name = agb_model + "_f" + f_agb + "_Z" + beta + "_eta" + eta
    ...
    if agb_model == "cristallo11":
        ...
        y_agb = 0.000060 # we will see, this model could cause chaos
    ...
    def y_cc(z):
        return y_cc_0 * eta * alpha_cc * (z/0.014)**beta

    vice.yields.ccsne.settings["C"] = y_cc

    run_model(name, agb_yields=agb_model, agb_factor=alpha_agb, n_yields="J22", eta_factor=eta)
