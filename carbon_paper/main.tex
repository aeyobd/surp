...
\defcitealias{2011ApJS..197...17C}{C11}
\defcitealias{2015ApJS..219...40C}{C15}
...
\begin{figure*}
    \centering
    \includegraphics[]{figures/subgiants_mgh.pdf}
    \includegraphics[]{figures/subgiants_mgfe.pdf}
...
\begin{itemize}
    \item~\VICE~\VICE~\VICE
    \item \citetalias{2015ApJS..219...40C}
    \item \cristallo
...
\begin{figure*}
    \centering
 	    \includegraphics[scale=1]{figures/agb_yields.pdf}\\
...
\begin{figure*}
    ...
    \includegraphics[scale=1]{figures/y_agb_vs_z-1.pdf}
    \includegraphics[scale=1]{figures/y_agb_vs_t-1.pdf}
...
\begin{figure*}
    \includegraphics[scale=0.9]{figures/y_c_cc-2.pdf}
    \includegraphics[scale=0.9]{figures/y_co_cc.pdf}
...
\begin{figure*}
\label{fig:c_evo}
\includegraphics{figures/evo_tracks-9.pdf}
\includegraphics{figures/evo_slices-2.pdf}
...
\begin{figure*}
\includegraphics[scale=0.6]{figures/oob_agb-1.pdf}
...
% \begin{figure*}
% \includegraphics[width=1.5\columnwidth]{figures/cooh_lateburst.pdf}
...
\begin{figure*}
\includegraphics[scale=0.6]{figures/beta-1.pdf}
\includegraphics[scale=0.6]{figures/f_agb-1.pdf}
...
\begin{figure*}
\includegraphics[scale=0.6]{figures/lateburst_eta-1.pdf}
...
\begin{figure}
    \includegraphics[scale=0.6]{figures/cooh_scatter.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.6]{figures/cnoh.pdf}
    \caption{Caption}
    \label{fig:cnofe}
\end{figure}
...
\begin{figure*}
\centering
\includegraphics[]{figures/summary-2.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.3]{figures/analytic_y-4.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[scale=0.5]{figures/fiorenzo_vs_jack_c-1.pdf}
    \includegraphics[scale=0.5]{figures/fiorenzo_vs_jack_n-1.pdf}
...
\begin{figure*}
\includegraphics[scale=0.45]{figures/agb_adj-2.pdf}
\includegraphics[scale=0.45]{figures/abg_adj_z-1.pdf}
