...
As our fiducial AGB yield, we use the \fruity\ table with \add{$\aagb=\cfactor$ or $\fagb=0.25$ based on a best-fit computed in Appendix~\ref{sec:extra_mcmc}.} 
...
To add artificial scatter into our models, we fit polynomials to the reported internal APOGEE error with metallicity: 
\begin{subequations}
