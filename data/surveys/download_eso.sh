...
if [ "$prompt" != "yes" ]; then
   ...
   then
      ...
      if [ $? -ne 0 ]; then
         ...
         echo "machine dataportal.eso.org login dboyea password _yourpassword_"
         prompt="yes"
      fi
   else
      prompt="yes"
...
"https://dataportal.eso.org/dataPortal/api/requests/dboyea/942013/SAF/ADP.2023-06-01T16:03:04.857/ADP.2023-06-01T16:03:04.857.fits"
